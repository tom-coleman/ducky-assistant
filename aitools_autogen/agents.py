...
class LeetCodeDailyProblemAgent(autogen.AssistantAgent):
    def __init__(self):
        super().__init__(name="LeetCode Daily Problem Agent", llm_config=None,
                         max_consecutive_auto_reply=3)
        self.register_reply([Agent, None], self._reply_func)
    ...
    def _reply_func(self,
        ...
        return True, self._get_daily_problem()

    def _get_daily_problem(self) -> Optional[Dict[str, str]]:
        result: Optional[Dict[str, str]] = dict()
